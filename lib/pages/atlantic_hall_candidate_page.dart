...
class AtlanticHallCandidatePage extends StatefulWidget {
  const AtlanticHallCandidatePage({super.key});

  @override
  State<AtlanticHallCandidatePage> createState() => _AtlanticHallCandidatePageState();
}

class _AtlanticHallCandidatePageState extends State<AtlanticHallCandidatePage> {
  @override
