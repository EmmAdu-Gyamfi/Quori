...
class CandidateThreeBioPage extends StatefulWidget {
  const CandidateThreeBioPage({super.key});

  @override
  State<CandidateThreeBioPage> createState() => _CandidateThreeBioPageState();
}

class _CandidateThreeBioPageState extends State<CandidateThreeBioPage> {
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Team \nJAK", style: GoogleFonts.roboto(fontWeight: FontWeight.bold, fontSize: 25),),
                      SizedBox(height: 8,),
