...
class CandidateFourBioPage extends StatefulWidget {
  const CandidateFourBioPage({super.key});

  @override
  State<CandidateFourBioPage> createState() => _CandidateFourBioPageState();
}

class _CandidateFourBioPageState extends State<CandidateFourBioPage> {
