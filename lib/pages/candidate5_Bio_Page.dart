...
class CandidateFiveBioPage extends StatefulWidget {
  const CandidateFiveBioPage({super.key});

  @override
  State<CandidateFiveBioPage> createState() => _CandidateFiveBioPageState();
}

class _CandidateFiveBioPageState extends State<CandidateFiveBioPage> {
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Team \nMYKEL", style: GoogleFonts.roboto(fontWeight: FontWeight.bold, fontSize: 25),),
                      SizedBox(height: 8,),
