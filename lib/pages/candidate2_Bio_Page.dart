...
class CandidateTwoBioPage extends StatefulWidget {
  const CandidateTwoBioPage({super.key});

  @override
  State<CandidateTwoBioPage> createState() => _CandidateTwoBioPageState();
}

class _CandidateTwoBioPageState extends State<CandidateTwoBioPage> {
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("The \nGovernor", style: GoogleFonts.roboto(fontWeight: FontWeight.bold, fontSize: 25),),
                      SizedBox(height: 8,),
