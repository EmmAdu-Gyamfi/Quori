...
import 'candidate1_Bio_Page.dart';
import 'candidate2_Bio_Page.dart';
import 'candidate3_Bio_Page.dart';
import 'candidate4_Bio_Page.dart';
import 'candidate5_Bio_Page.dart';

class SrcCandidatePage extends StatefulWidget {
  const SrcCandidatePage({super.key});

  @override
  State<SrcCandidatePage> createState() => _SrcCandidatePageState();
}

class _SrcCandidatePageState extends State<SrcCandidatePage> {
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CandidateOneBioPage() ));
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CandidateTwoBioPage() ));
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CandidateThreeBioPage() ));
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CandidateFourBioPage() ));
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => CandidateFiveBioPage() ));
